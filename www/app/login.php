...
<section class="py-5">
    <div class="container py-5">
        <div class="row mb-4 mb-lg-5">
            <div class="col-md-8 col-xl-6 text-center mx-auto"><p class="fw-bold text-primary mb-2">Login</p>
                <h2 class="fw-bold">Welcome back</h2></div>
        </div>
                ...
                <div class="card">
                    <div class="card-body text-center d-flex flex-column align-items-center">
                        ...
                        <form method="post">
                            ...
                            <p class="text-muted">Forgot your password?</p></form>
                    </div>
                </div>
            </div>
        </div>
